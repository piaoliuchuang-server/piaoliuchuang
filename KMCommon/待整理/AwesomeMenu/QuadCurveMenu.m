...
#define STARTPOINT CGPointMake(50, 860)
...
- (id)initWithFrame:(CGRect)frame menus:(NSArray *)aMenusArray startPoint:(CGPoint)point
{
    self = [super initWithFrame:frame];
    if (self) {
        self.backgroundColor = [UIColor clearColor];
        ...
        // add the "Add" Button.
        _addButton = [[QuadCurveMenuItem alloc] initWithImage:[UIImage imageNamed:MENU_BG_TRANSPARENT]
                                             highlightedImage:[UIImage imageNamed:MENU_BG_TRANSPARENT] 
                                                 ContentImage:[UIImage imageNamed:MENU_ICON] 
                                      highlightedContentImage:[UIImage imageNamed:MENU_ICON]];
...
- (void)addMenus:(NSArray *)aMenusArray startPoint:(CGPoint)point
{
